# [Clone List with Next and Random](https://www.geeksforgeeks.org/problems/clone-a-linked-list-with-next-and-random-pointer/1?page=2&difficulty=Hard&sortBy=submissions)
## Hard
